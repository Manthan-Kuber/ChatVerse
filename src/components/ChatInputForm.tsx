...
const ChatInputForm = (props: {
  ...
  return (
    ...
    >
      <textarea
        className="w-full resize-none rounded-md border-2 border-neutral-600 bg-neutral-500/10 px-4 py-2 pr-10 outline-none transition-transform duration-200 focus:border-lime-300"
